    ...
    <div className="space-y-12">
      <div className="border-b border-gray-300 pb-12 grid grid-cols-12">
        ...
        <div className=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="sm:col-span-4">
            <Input label={"Username"} placeholder={"RealKrazyWoman"}></Input>
          </div>
      ...
      <div className="border-b border-gray-900/10 pb-12 grid grid-cols-12">
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="sm:col-span-4">
            <Input label={"Email Address"} placeholder={"realkrazywoman@prnk.com"}></Input>
          </div>
          ...
          <div className="col-span-full">
            <Input label={"Street Address"} placeholder={"Serangoon North Avenue 3"}></Input>
          </div>
