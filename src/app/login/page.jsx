    ...
    >
        ...
        >
          ...
          >
            ...
            <div className="justify-center items-center flex gap-5 mb-10 w-full ">
              ...
              <span className="font-bold text-[20px] lg:text-[40px] text-gray-400" >Supreme Thrifters</span>
            </div>
      ...
      <div className="absolute h-full w-full top-0 left-0 grid md:grid-cols-2 max-md:grid-rows-[1fr_2fr_1fr] ">
        ...
        >
          ...
          >
            <h3 className="text-2xl text-gray-700">Welcome Back!</h3>
        ...
        >
          ...
          >
            ...
            <h3 className="text-2xl text-gray-700">Hello, Friend!</h3>
            <p className="text-gray-600">
